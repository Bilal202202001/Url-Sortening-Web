        ...
        <form onSubmit={handleForm} className="w-screen h-3/4">
            <div className="flex flex-1 flex-col justify-center lg:px-8">
                ...
                <div className="sm:mx-auto sm:w-full sm:max-w-sm mt-5">
                    ...
                    <input type="email" defaultValue="" id="email" name="email" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-800 focus:ring-2 focus:ring-inset focus:ring-gray-400 sm:text-sm sm:leading-6 mt-3" />
                </div>
                <div className="sm:mx-auto sm:w-full sm:max-w-sm mt-5">
                ...
                <div className="sm:mx-auto sm:w-full sm:max-w-sm mt-5">
                    <label htmlFor="cnfrmPassword" className="block text-sm font-medium leading-6 text-gray-900">
                        Confirm Password
                    </label>
                    <input type="password" defaultValue="" id="cnfrmPassword" name="cnfrmPassword" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-800 focus:ring-2 focus:ring-inset focus:ring-gray-400 sm:text-sm sm:leading-6 mt-3 w-30" />
                </div>
                <div className="mt-5">
                    <button
                        type="submit"
